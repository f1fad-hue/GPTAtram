...
if (!ddFunds.nasdaq.forwardBasis.includes('IE000U9J8HX9') || !ddFunds.nasdaq.forwardMetric.includes('JPM target ETF')) fail('Nasdaq forward DD median must be explicitly based on the exact JPM target ETF.');
