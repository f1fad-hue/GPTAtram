...
- Net CAGR: gross 10-year scenario minus every ATRAM A PHP wrapper/operating fee and the target manager's current official target-fund/ETF fee. When documents conflict, the direct target-manager disclosure controls the target fee and the conflict remains visible.
- Explicit target inputs: Fidelity 10.61% after its official 1.89% OCF and Nasdaq UCITS 9.89% after its applicable target-level fee adjustment. The optimizer then deducts the complete ATRAM A PHP wrapper fees and uses fully net 9.36% and 8.24%; Peso Money Market has no target and remains 3.47% net.
