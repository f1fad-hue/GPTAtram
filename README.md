...
- Optimizer: exhaustive maximum fully net 10-year CAGR search on a 5% grid with every required fund at least 5%.
...
`npm test` validates the four-fund schema, complete fee math, macro and regional scores, DD inputs, exhaustive optimizer, Monte Carlo, source/claim registries, and current official JPMorgan target histories. The authoritative audit rejects unknown or unused sources.
